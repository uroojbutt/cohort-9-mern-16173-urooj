...
- Yellow/black themed UI (marigold `#F4C430` on ink black `#121212`), centered auth forms, a dot-grid background, and `lucide-react` icons.
- Responsive layout using Tailwind's `sm:` breakpoint prefixes; `min-h-screen` used instead of `overflow-hidden` to avoid clipping content on smaller viewports.
...
GitHub: [github.com/uroojbutt](https://github.com/uroojbutt)
---
